...
from giskardpy_ros.tree.behaviors.cleanup import DeactivateHSRControllers
...
class PostProcessing(Sequence):
    ...
    def add_hsr_controller_deactivate(self):
        self.add_child(DeactivateHSRControllers())